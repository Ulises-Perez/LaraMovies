...
<body>
  ...
  @switch(true)
      @case(Route::currentRouteName() == "peliculas.index")
          <div class="menu-phone fixed bottom-0 w-full block md:hidden">
              <div class="box">
                  <ul class="bg-back-oficial border-t border-gray-500 border-opacity-25 w-full rounded-t-xl flex justify-between py-2 px-4 gap-4">
                      <li>
                          <a class="text-center text-2xl block py-1 px-3 text-white" href="{{route('welcome')}}">
                              <i class="fas fa-home"></i>
                              <p class="text-xs">Inicio</p>
                          </a>
                      </li>
                      <li>
                          <a class="text-center text-2xl block py-1 px-3 text-white rounded-xl bg-red-500" href="{{route('peliculas.index', $page=1)}}">
          ...
          @break
      @case(Route::currentRouteName() == "series.index")
          <div class="menu-phone fixed bottom-0 w-full block md:hidden">
              <div class="box">
                  <ul class="bg-back-oficial border-t border-gray-500 border-opacity-25 w-full rounded-t-xl flex justify-between py-2 px-4 gap-4">
                      <li>
                      ...
                      <li>
                          <a class="text-center text-2xl block py-1 px-3 text-white rounded-xl bg-red-500" href="{{route('series.index', $page=1)}}">
                              <i class="fas fa-theater-masks"></i>
                              <p class="text-xs">Series</p>
                          </a>
                      </li>
          ...
          @break
      @case(Route::currentRouteName() == "listas.index")
          <div class="menu-phone fixed bottom-0 w-full block md:hidden">
              <div class="box">
                  <ul class="bg-back-oficial border-t border-gray-500 border-opacity-25 w-full rounded-t-xl flex justify-between py-2 px-4 gap-4">
                      <li>
                      ...
                      <li>
                          <a class="text-center text-2xl block py-1 px-3 text-white rounded-xl bg-red-500" href="{{route('listas.index')}}">
                              <i class="fas fa-list-ol"></i>
                              <p class="text-xs">Listas</p>
                          </a>
                      </li>
