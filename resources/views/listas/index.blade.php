        ...
        <div class="w-full">
            <div class="mx-auto pt-20">
                ...
                <section id="lista_los_vengadores" class="mb-1">
                    <div class="lista-image-background" style="background-image: url('https://image.tmdb.org/t/p/w780/7RyHsO4yDXtBv1zUU3mTpHeQ0d5.jpg')">
                        <div class="sombra-list bg-black bg-opacity-75">
                            <div class="grid grid-cols-5 gap-6 p-2 lg:p-20 text-white relative lg:py-4 flex justify-center items-center align-center">
                                <div class="title-lista col-span-5 lg:col-span-1 flex justify-start items-center">
                                    <h1 class="text-lg lg:text-xl my-4 p-2 backdrop-blur rounded-r border-white border-l-2">{{$listaTheAvengers['name']}}</h1>
                                </div>
                                <div class="col-span-5 contenido">
                                    <div class="temporadas h-auto w-full overflow-auto flex gap-4">
